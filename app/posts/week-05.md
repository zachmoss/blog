...
Confit greens and egg breakfast bap at [Franks Canteen](https://www.instagram.com/frankscanteen/) — 9/10
...
I noticed an [interesting tweet](https://twitter.com/ceosthelena/status/1595541529468325893) from one of our board members on Wednesday. It reminded me of an idea I had with [Ivor](https://twitter.com/ivorinfo) years ago about how we might reduce the duplication of work in the end of life sector.

I don’t think the end of life sector is unique, but having worked in it for approaching 10 years I think it’s quite bad with duplication of work. What I think this means is that there are many busy and talented people whose energy and passion isn’t being used in the best way. There are many problems with how we deal with death and dying in the UK, and sometimes it’s exasperating because I think we have the answers and solutions to most problems — it’s just that processes, systems and stuff just gets in the way. **I think some form of pattern or user research library for the end of life sector could address _some_ of these problems. If you don’t know what this type of library is — I am no expert but these are some useful links and examples:**

* [Data patterns catalogue by IF](https://catalogue.projectsbyif.com/)— helps teams make decisions about how, when and why to collect and use data about people.
* Interesting blog from Service Transformation team at Essex council about [prototyping a service pattern library](https://servicetransformation.blog.essex.gov.uk/2019/06/21/prototyping-a-service-pattern-library/).
* [Mental Health Patterns Library](https://designpatternsformentalhealth.org/) — created by designers, developers and mental health practitioners and researchers who saw a need to collect and share best practices for mental health digital services.
* [Local Government User Research Library ](https://research.localgov.digital/)— helps local government teams share, discover and connect user research.
...
![A picture of a dog named Guinness chewing my slipper.](/images/week-05-3ea70b14.jpeg)
