...
<figure>
  <img src="/images/blot-week29.jpg" alt="An absolute beauty of a restaurant in Mallorca">
  <figcaption>An absolute beauty of a restaurant in Mallorca</figcaption>
</figure>

## The same old problem with DNR decisions
We [released a report](https://twitter.com/AGoodDeath/status/1768200226957902239) last week which showed medics are still really bad at communicating DNR (do not resuscitate) decisions. It's pretty depressing reading, as it seems not much has changed since we released our last report during the pandemic. We're still seeing the same failures around communication and knowledge of the law. The results are equally distressing for people and their relatives.

It's timely, as I've applied for a [Churchill Fellowship](https://www.churchillfellowship.org/) to look into what we can learn from other countries. I'm on an interview waitlist so I'm trying to not get too invested in the idea. I am excited though by the prospect of seeing how other nationalities and cultures deal with this problem as we just have not cracked it here in the UK.
...
We're at the stage of testing our content on best interests decisions and so came to a familiar challenge of how best to prototype our content. In my last weeknote I mentioned we're looking at trying the [step-by-step pattern](https://design-system.service.gov.uk/patterns/step-by-step-navigation/) from the GOV.UK Design System to present options to our users. Because of this, I thought I'd have a crack at using the [GOV.UK Prototype Kit](https://prototype-kit.service.gov.uk/docs/) to mock-up our page.
...
<figure>
  <img src="/images/blot-BI-mockup.jpeg" alt="Our protoype webpage">
  <figcaption>Our protoype webpage</figcaption>
</figure>
...
<figure>
  <img src="/images/blot-hike.jpg" alt="Lovely hike">
  <figcaption>Lovely hike</figcaption>
</figure>

<figure>
  <img src="/images/blot-terrace.jpg" alt="Breakfast">
