...
In May this year I went along to observe a hearing at the Court of Protection. It’s something [we at Compassion in Dying do sometimes](https://openjusticecourtofprotection.org/2022/06/23/she-is-religious-and-she-is-a-fighter-three-perspectives-on-best-interests-decision-making-in-the-court-of-protection-from-compassion-in-dying/) as the decisions made by this court are relevant to the people we support.
...
1. the NHS should withdraw medical treatment, or 
2. a serious medical treatment decision is in a person's best interests

Sometimes there are very specific cases about an [advance decision to refuse treatment (ADRT)](https://compassionindying.org.uk/how-we-can-help/living-will-advance-decision/) or [lasting power of attorney (LPA)](https://compassionindying.org.uk/how-we-can-help/lasting-power-attorney-health-welfare/) which may also be relevant.
...
The particular case I observed was about someone who’d made an ADRT, and specifically whether it was ‘valid’ and ‘applicable’ to their situation. The [full judgment](https://caselaw.nationalarchives.gov.uk/ewcop/t3/2025/20) or a [blog post about the case](https://openjusticecourtofprotection.org/2025/05/05/determining-the-legal-status-of-a-living-will-personal-reflections-on-a-case-before-poole-j/) are worth reading if you have time as they set out the wider picture and context of the situation.
...
<figure>
  <img src="/images/blot-judgment.png" alt="Passage from the judgment about the NHS Trust guidance">
...
Having had a chat with a colleague about the feasibility of submitting a [freedom of information (FOI) request](https://www.whatdotheyknow.com/help/about_foi) we decided as a team it was worth doing.
...
Given there are over 200 NHS Trusts (of varying descriptions) we decided to use [WhatDoTheyKnow Pro](https://www.whatdotheyknow.com/pro) to submit a batch FOI request. 

<figure>
  <img src="/images/blot-wdtk.png" alt="Screenshot of the WhatDoTheyKnow Pro dashboard">
...
1. Does the Trust have a policy which outlines responsibilities of healthcare professionals towards patients who have an advance decision to refuse treatment or lasting power of attorney?
2. If there’s a dispute does the Trust have a process or course of action the person should follow?
3. Does the Trust have someone responsible for overseeing compliance with the Mental Capacity Act?
...
I ran a [half-day workshop](https://docs.google.com/presentation/d/1xShDOgdOl0nwD8f6YUvyQ0OyUs6Q2YmQTeII4uUYMTg/edit?usp=sharing) with the team to go through these last week which I think was helpful to get everyone up to speed on what we’ve found so far. 
...
The most common type of policy was some form of policy for ‘complying with the Mental Capacity Act’. But even here there were differences - some for example included [Deprivation of Liberty Safeguards (DOLS)](https://www.scie.org.uk/mca/dols/at-a-glance/) and others had separate policies.

<figure>
  <img src="/images/blot-sandwell.png" alt="Sandwell and West Birmingham Mental Capacity Act Policy">
...
<figure>
  <img src="/images/blot-docversion.png" alt="Calderdale and Huddersfield NHS Foundation Trust policy document history">
...
<figure>
  <img src="/images/blot-flowchart.png" alt="ADRT Treatment Pathway from Mersey and West Lancashire Teaching Hospitals NHS Trust policy on advance decisions">
...
<figure>
  <img src="/images/blot-dispute.png" alt="Example policy content on dispute process">
...
2. How it might help the people we support
3. How it might support our organisational policy goals
3. How much work it *might* take for their ideas
...
I prompted a bit of retrospective ‘[dot voting](https://www.nngroup.com/articles/dot-voting/)’ a few days after the workshop and it looked like this idea was most popular:

<figure>
  <img src="/images/blot-dotvote.png" alt="Dot votes on one of our workshop ideas">
...
1. Sarah and Amber used the policy from Mid + South Essex Foundation Trust in some training they did with some of their staff.
2. Sarah used the policy from a particular NHS Trust in an email to support someone’s request to have a medical device removed. The policy backed up that request.
